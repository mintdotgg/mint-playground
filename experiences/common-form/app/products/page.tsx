...
function ProductsContent() {
	...
	return (
		<div className="store-container py-12 sm:py-16">
			<div className="mb-10">
				<p className="store-kicker">Common Form / 2026</p>
				<h1 className="store-heading">The collection</h1>
				<p className="mt-3 max-w-xl text-lg leading-relaxed text-foreground/65">
					Six useful objects, chosen for tactile materials and lasting proportions.
				</p>
			</div>
